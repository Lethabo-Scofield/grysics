...
export default function HowItWorksContent() {
  return (
    ...
    <div className="min-h-screen bg-white text-neutral-900 relative">
      ...
      <main>
      <section className="pt-28 sm:pt-40 pb-16 sm:pb-32 bg-neutral-950 text-white overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <h1 className="font-serif text-2xl sm:text-5xl lg:text-6xl tracking-tight mb-3 sm:mb-4">
      ...
      <section className="py-16 sm:py-32 border-b border-neutral-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <motion.div
            ...
            custom={1}
            variants={fade}
            className="bg-neutral-950 rounded-xl sm:rounded-2xl p-4 sm:p-10 border border-neutral-200/10 overflow-x-auto"
          >
            <LLMNetworkDiagram />
          </motion.div>
        </div>
