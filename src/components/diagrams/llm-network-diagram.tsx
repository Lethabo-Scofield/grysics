...
export default function LLMNetworkDiagram() {
  ...
  return (
    <motion.div
      ...
      role="img"
      aria-label="Network diagram showing LLMs connected to Grysics execution engine"
    ...
    >
      <svg viewBox={`0 0 ${W} ${H}`} className="w-full h-auto" aria-hidden="true">
        ...
        <text x={CX} y={CY + 65} textAnchor="middle" fill="rgba(255,255,255,0.3)" fontSize="9">Execution Engine</text>
